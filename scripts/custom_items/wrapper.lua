require "scripts.custom_items.class"
ItemWrapper = class()

function ItemWrapper:init()
end

function ItemWrapper:createItem(name)
    local function invokeLeftClick(item)
        return item.ItemState:onLeftClick()
    end
    local function invokeRightClick(item)
        return item.ItemState:onRightClick()
    end
    local function invokeMiddleClick(item)
        return item.ItemState:OnMiddleClick()
    end
...
function ItemWrapper:onLeftClick()
end

--  Called when your item is right-clicked
function ItemWrapper:onRightClick()
end

--  Called when your item is middle-clicked
function ItemWrapper:OnMiddleClick()
end
...
function ItemWrapper:canProvideCode(code)
    return false
end
...
function ItemWrapper:load(data)
    return true
end
...
function ItemWrapper:propertyChanged(key, value)
end
